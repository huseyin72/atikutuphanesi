...
for (var i = 0; i < select1Array.length; i++) {
    var k = i +1;
    select1Array[i] =  select1Array[i].toLowerCase();
    select1Array[i] = k +" " + select1Array[i].charAt(3).toUpperCase() + select1Array[i].slice(4);
    //select1Array[i] = select1Array[i].charAt(0).toUpperCase()
